...
def test_compute_policy():
    ...
    B = np.array([[0.0], [0.0195122], [0.0], [-0.02926829]])
    m = np.array([[0.0], [0.0], [0.0], [0.0]])
    C = np.array(
        [
            [575.55653791, 312.02835942, 995.6067982, 258.142569],
    ...
    A = np.array(
        [
            [1.0, 0.02, 0.0, 0.0],
            [0.0, 1.0, -0.00873472, -0.00114593],
            [0.0, 0.0, 1.0, 0.02],
            [0.0, 0.0, 0.30070484, 1.00164212],
        ]
    )
    B = np.array([[0.0], [0.0193883], [0.0], [-0.02778353]])
    m = np.array(
        [[2.58593147e-12], [-2.54870172e-03], [8.50208792e-13], [4.07885872e-03]]
    )
    C = np.array(
        [
            [576.58162709, 313.21303493, 1034.03217331, 271.15499211],
...
def test_compute_Q_params():
    ...
    all_data = {
        1: {
            ...
            "n_a": 5,
            "C": [
                [1.86509963, 2.46735175, 0.98151751],
                [2.46735175, 3.39048201, 1.46508863],
                [0.98151751, 1.46508863, 1.16780443],
            ],
            "D": [
                [3.70345222, 3.29591738, 3.37993428, 2.13183605, 3.27928912],
        ...
        2: {
            ...
            "n_a": 4,
            "C": [
                [3.8200755, 3.60719867, 4.08455495, 5.5019658],
            ...
            "D": [
                [4.86154953, 3.91279569, 5.54873046, 1.83141928],
            ...
            "E": [
                [6.92979364, 5.76476509, 7.40212395, 2.10973581],
            ...
            "f": [[8.34985883], [7.72212252], [9.8734455], [15.29872877]],
            "g": [[10.82501261], [9.28890487], [11.82440483], [3.05679771]],
            "h": [7.89630723],
        },
        3: {
            "n_s": 5,
            "n_a": 3,
            "C": [
                [9.65933602, 7.45774817, 7.78943428, 5.16067427, 10.56498348],
            ...
            "D": [
                [11.66089488, 10.38138664, 10.60025769],
                [10.38138664, 9.72434538, 9.8785213],
                [10.60025769, 9.8785213, 10.5124801],
            ],
            "E": [
                [18.08622261, 16.8973519, 18.58286012],
            ...
            "g": [[15.32133184], [14.06823418], [16.06171689]],
            "h": [7.259854],
        },
    }
    ...
    for seed, data in all_data.items():
        ...
        C, D, E, f, g, h = lqr_controller.compute_Q_params(
            A, B, Q, R, M, q, r, m, b, P, y, p
        )
...
def test_compute_V_params():
    ...
    all_data = {
        1: {
            ...
            "n_a": 5,
            "P": [
                [16.30582914, 8.7705151, 14.10180752],
        ...
        2: {
            ...
            "n_a": 4,
            "P": [
                [6.04542824, 5.08607438, 8.03010968, 7.80303096],
        ...
        3: {
            ...
            "n_a": 3,
            "P": [
                [5.1514923, 3.80911917, 4.25747437, 2.61608615, 2.41962335],
        ...
        4: {
            ...
            "n_a": 6,
            "P": [
                [20.03662266, 19.11700919, 20.9792493, 15.78053114],
...
if __name__ == "__main__":
    ...
    print(
        "Make sure to test your policy by running `python cartpole.py --env LQR` (hint: the cart pole should stay up if it's correct)"
    )
